...
if (room == rCultistBattle){
	...
	if (state = "INIT"){
		...
		cultist_ = instance_create_depth(aMonsterPos[2, 0], aMonsterPos[2, 1], -100, oCultistBattle);
		cultist_.dead = false;
		cultist_.stunned = 0;
		cultist_.number = 1
		cultist_.isAsleep = false;
		cultist_.hp = cultist[0, 1];
		ds_list_add(dsTargetMonsters, cultist_);
